...
<html>
  ...
  <body>
    <div class="sidenav">
      <img src="https://res.cloudinary.com/synee/image/upload/v1535529894/african-1296524_640_y7hpjx.png">
      <a href="">${user.name}</a>
      <a href="/userTasks">Home</a>
      <a href="/logout">Logout</a>
      
    </div>
    <div class="listBody">
      <h1>Create Your Pocketbook</h1>
      <p><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addModal">
          Add Task
        </button>
      </p>
		...
		<table>
				<thead>
					<tr>
			          <th>To Do</th><th class="alignRight">Due Date</th>
			        </tr>
				</thead>
				<tbody>
					<c:forEach var="task" items="${task}">
					<tr>
						<td> • ${task.description}</td> <td class="alignRight">${task.dueDate}</td>
